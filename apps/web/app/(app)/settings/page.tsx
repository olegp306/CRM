      ...
      <div className="grid gap-3">
        <div>
          ...
          <div className="mt-2 grid gap-3">
            ...
            <a href="/settings/telegram-runtime" className="rounded-lg border border-border bg-white p-4 transition hover:bg-muted">
              <h3 className="text-base font-semibold">Telegram runtime</h3>
              <p className="mt-2 text-sm text-muted-foreground">Switch Telegram between legacy routing and the LangGraph test runtime.</p>
            </a>
