...
- Release planning history:
  ...
  - `releaseHistorySummary` exposes the top planning actor for a quick operator-facing summary, with singular/plural event labels and `No actor yet` / `No actor events yet` empty states before planning starts.
