...
- Release planning history:
  ...
  - `releaseHistorySummary` exposes the top planning actor for a quick operator-facing summary, with `No actor yet` and `No actor events yet` empty states before planning starts.
