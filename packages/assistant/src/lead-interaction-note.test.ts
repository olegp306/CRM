...
describe("lead interaction note commands", () => {
  ...
  it.each([
    "\u0414\u043e\u043f\u043e\u043b\u043d\u0438\u0442\u0435\u043b\u044c\u043d\u0430\u044f \u0438\u043d\u0444\u043e\u0440\u043c\u0430\u0446\u0438\u044f: \u043a\u043b\u0438\u0435\u043d\u0442 \u043b\u044e\u0431\u0438\u0442 \u043a\u043e\u0440\u043e\u0442\u043a\u0438\u0435 \u043f\u0438\u0441\u044c\u043c\u0430.",
    "\u0417\u0430\u043f\u043e\u043c\u043d\u0438 \u043e\u0431 \u044d\u0442\u043e\u043c \u043a\u043b\u0438\u0435\u043d\u0442\u0435: \u043e\u043d \u043b\u044e\u0431\u0438\u0442 \u0434\u0436\u0430\u0437.",
    "\u0412\u0430\u0436\u043d\u043e \u043f\u0440\u043e \u043a\u043b\u0438\u0435\u043d\u0442\u0430 - \u043e\u043d \u0431\u0443\u0434\u0435\u0442 \u043d\u0430 \u0432\u044b\u0441\u0442\u0430\u0432\u043a\u0435 \u0432 \u0438\u044e\u043d\u0435.",
    "Client context: prefers short emails and likes jazz.",
    "Remember about this client: she prefers WhatsApp."
  ])("detects explicit client context keywords: %s", (message) => {
    expect(isLeadNaturalContextNote(message)).toBe(true);
    expect(createLeadNaturalContextSummary(message)).toContain("Client context:");
  });
