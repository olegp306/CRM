...
export const CLIENT_MATERIAL_ANALYSIS_DEFAULT_PROMPT = [
  ...
  "If this block exists, Telegram undo confirmations may append one phrase on the next line below the fixed line: undo successful and logged",
  "Edit these lines per workspace to personalize the Telegram bot voice. Remove this block or leave it empty for neutral undo confirmations.",
